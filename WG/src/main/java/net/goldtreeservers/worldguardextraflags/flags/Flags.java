...
public final class Flags
{
	...
	public final static BooleanFlag ALLOW_WIND_BURST = new BooleanFlag("allow-windburst");
	public final static BooleanFlag DESTROY_ITEMS = new BooleanFlag("destroy-items");
